...
export type IApiDeleteResponse = Response<IApiResponseSuccess<{ deletedCount: number }> | IApiResponseError>;
...
export type ApiRequest<B = Record<string, string|object>, Q = Record<string, string>, P = Record<string, string>> = Request<P, any, B, Q>;