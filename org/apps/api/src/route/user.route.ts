...
export default class UserController extends ManagerController {
    ...
    private getAll = async (req: ApiRequest<PaginationBody>, res: ApiResponsePagination<User>, next: NextFunction): Promise<void> => {
    ...
    private create = async (req: ApiRequest, res: ApiResponse<PublicUser>, next: NextFunction): Promise<void> => {
    ...
    private getOne = async (req: ApiRequest<{ id: Types.ObjectId }>, res: ApiResponse<PublicUser>, next: NextFunction): Promise<void> => {
        const { id } = req.body;
    ...
    private update = async (req: ApiRequest<Partial<User> & {
        id: Types.ObjectId;
    ...
    private me = async (req: ApiRequest<{
        id: Types.ObjectId;
    ...
    private getByEmail = async (req: ApiRequest, res: ApiResponse<PublicUser>, next: NextFunction): Promise<void> => {
