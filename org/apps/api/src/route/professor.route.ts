...
export default class ProfessorController extends ManagerController {
    ...
    private create = async (req: ApiRequest, res: ApiResponse<PublicProfessor>, next: NextFunction): Promise<void> => {
    ...
    private update = async (req: ApiRequest<Partial<Professor> & { id: Types.ObjectId }>, res: ApiResponse<PublicProfessor>, next: NextFunction) => {
