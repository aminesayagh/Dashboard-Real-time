...
export type ApiDeleteResponse = Response<
  ApiResponseSuccess<{ deletedCount: number }> | ApiResponseError
>;
...
export type IApiResponsePagination<T> =
  | ApiSuccessResponsePagination<T>
  | ApiResponseError;
...
export type ApiRequest<B = DefaultB, Q = DefaultQ, P = DefaultP> = Request<
  P,
  unknown,
  B,
  Q
